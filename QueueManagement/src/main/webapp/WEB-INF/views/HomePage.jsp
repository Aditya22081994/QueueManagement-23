...
<html lang="en">
<head>
  <title>GroupFund Home Page</title>
  <meta charset="utf-8">
...
<nav>
<a href="<c:url values="/home" />">HOME</a>
...
<div class="dropdown">
  <button class="btn btn-default dropdown-toggle transparent" type="button" data-toggle="dropdown">LOG IN
  <span class="caret"></span></button>
  <ul class="dropdown-menu">
    <li><a href="AdminLogIn.html"><b>Administrator</b></a></li>
    <li><a href="BankingOfficerLogIn.html"><b>Banking Officer</b></a></li>
    <li role="presentation" class="divider"></li>
    <li><a href="CustomerLogIn.jsp"><b>Customer</b></a></li>
  </ul>
